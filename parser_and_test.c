...
void test_and_register(void **state) {
...
void test_wrong_and_instruction(void **state) {
...
int main(int argc, char const *argv[]) {
    const struct CMUnitTest tests[] = {
        cmocka_unit_test(test_and_register),
        ...
        cmocka_unit_test(test_wrong_and_instruction),
